 ...
 * Use the [ScreenOne.newInstance] factory method to
...
class ScreenOne : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var theName = ""
        val myEditText = view.findViewById<EditText>(R.id.my_edit_text)
        val myButton = view.findViewById<Button>(R.id.my_button)
        myEditText.setText(param1)
        theName = myEditText.text.toString()
